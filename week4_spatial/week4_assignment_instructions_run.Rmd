...
Here I am uploading this run using Colorado as the second state. This version is to make it possible for students to complete the reflection parts of the exercise even if we can't get the code to run. 
